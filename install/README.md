...
packages are built by `.github/workflows/release.yml` and published as draft
releases to the public repository (see `docs/releasing.md`).
`virustotal-scan.ps1` scans a package on VirusTotal for the release notes.
